...
export default function FacuTokenICO() {
    ...
    // Functions
    const isLoading = () => account == null || contractFT == null || contractFTS == null || tokensSold == null || transactionCount == null || ethFunds == null || ethPrice == null;
    const SliderValue = () => {
        ...
        <VStack minH='800px' w='full' bg={bg}>
          ...
          <HStack w='md' display={{lg: 'flex', md: 'flex', sm: 'none', base: 'none'}}>
            ...
            <Link href='https://faucets.chain.link/' isExternal>
              <Button bg='gray.700' color='gray.200' variant='link' w='100px' minH='40px'>Get ETH</Button>
            </Link>
          </HStack>
           {/* Mobile */}
           <HStack w='full' display={{lg: 'none', md: 'none', sm: 'flex', base: 'flex'}}>
            ...
            <Spacer/>
            <Link href='https://faucets.chain.link/' isExternal>
              <Button bg='gray.700' color='gray.200' variant='link' w='120px' minH='40px' p={2}>Get ETH</Button>
            </Link>
            <Box w='5px'/>
          </HStack>
          <Box h='10px'/>
          ...
          <Button variant='wpp' onClick={ () => setIsOpen(true) }>BUY TOKENS</Button>
          <Box h='10px' />
          {/* Desktop */}

        ...
        <HStack bg={bg} w='full' h={height}>
            ...
            <VStack h={height}>
                ...
                <Image 
                    ...
                    alt='Hello There'
                />
                <Text fontSize={['20px','20px','0px','0px']}>Hola, soy</Text>
                <Heading fontSize={['30px','40px','0px','0px']}>Facundo Carballo</Heading>
                {/* <Text fontSize={['20px','20px','0px','0px']}>y quiero...</Text> */}
                <Spacer/>
            </VStack>
            <Spacer/>
        </HStack>
...
const LandingDesktop = ({width, height, bg}: ContextProps) => {
    ...
    <HStack bg={bg} w='full' h={height}>
        ...
        <Spacer/>
        <Box>
            <Text fontSize={[0,0,'20px','25px']}>Hola me llamo,</Text>
            <Heading fontSize={[0,0,'47px','75px']}>Facundo Carballo</Heading>
            {/* <Text fontSize={[0,0,'20px','25px']}>y quiero...</Text> */}
        </Box>
        <Box w='80px'/>
    </HStack>
    )

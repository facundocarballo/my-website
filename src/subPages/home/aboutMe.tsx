            ...
            <VStack>
                ...
                <HStack>
                    ...
                    <Text fontSize={['20px','20px','0px','0px']} textAlign='justify'>
                        I’m a student of Computer Engenieering at UNLAM. In my free time I like to learn new things about software development, which I try to implement creating functional applications.
                    </Text>
                    <Spacer/>
                </HStack>
                <Image 

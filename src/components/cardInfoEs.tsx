...
export const CardInfoES = (cardInfoProps: TheCardInfoProps) => {
    ...
    return (
        ...
        <VStack w='full' h='70vh'>
            <Spacer/>
            <Heading>No hay informacion todavia</Heading>
            <Spacer/>
        </VStack>
        : 
        <Box id='cardsInfo'>
                    ...
                    <VStack h='full' w='full'>
                        <Container bg={bg} padding='5px' style={{borderRadius: '10px'}}>
                            <Box bg={bgBox} style={{borderRadius: '10px'}}>
                                ...
                                <Box h='2.5px'/>
                                <Text as='i' fontSize='xs' style={{textAlign: 'justify'}} marginLeft='10px'>{ props.fecha }</Text>
                                <Box h='2.5px'/>
                            </Box>
                            <Box h='10px'/>
                            <Heading>{ props.titulo }</Heading>
                            <Box h='5px'/>
                            <Text fontSize='xs' style={{textAlign: 'justify'}} p={2}>{ props.descripcion }</Text>
                            <HStack w='full'>
                                <Spacer/>
                                {
